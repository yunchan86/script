@echo off
rem 源文件生成目录
set SRC_PATH="D:\worker\tools\mybatis-generator-core-1.3.1-bundle\mybatis-generator-core-1.3.1\kubang\src"
...
set CONFIG_FILE="D:\worker\tools\mybatis-generator-core-1.3.1-bundle\mybatis-generator-core-1.3.1\kubang\kubang.xml"
rem 源文件目录是否存在
