@echo off
rem 源文件生成目录
set SRC_PATH="D:\worker\tools\mybatis-generator-core-1.3.1-bundle\mybatis-generator-core-1.3.1\luyou\src"
...
set CONFIG_FILE="D:\worker\tools\mybatis-generator-core-1.3.1-bundle\mybatis-generator-core-1.3.1\luyou\luyou.xml"
rem 源文件目录是否存在
